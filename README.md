...
Neste projeto são abordados conceitos e melhores práticas do mercado no desenvolvimento de aplicações em C# confiáveis e estruturadas.
...
Podemos tornar o consumo ainda mais interessante criando uma _Sugar Syntax_ através de métodos de extensão.
